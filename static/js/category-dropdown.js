...
(function () {
    ...
    const categoryGroups = {
        ...
        'ケーブル・ネットワーク': [
            'Wi-Fiルーター', 'ルーター・ネットワーク機器', '無線・有線LANルーター', '無線・有線LAN中継器', '電源タップ', 'ケーブルオーガナイザーバッグ'
        ],
        ...
        '美容・健康': [
            ...
            'メイクアップ', 'ボディケア', '保湿ミスト・スプレー', '理美容家電', '理美容・健康家電', 'フットマッサージャー'
        ],
        'サプリメント': [
            'サプリメント・ビタミン', 'ビタミンC', 'プロテイン', 'マルチビタミン', 'マルチミネラル', 'マルチ脂肪酸', 'ホエイプロテイン'
        ],
        'ファッション': [
            'インソール', 'パジャマ・ルームウェアボトムス', 'ベビー・マタニティ', 'ベスト', 'メンズシューズ'
        ],
