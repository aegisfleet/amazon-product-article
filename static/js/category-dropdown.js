...
(function () {
    ...
    const categoryGroups = {
        // --- IT & デバイス ---
        'PC・周辺機器': [
            'PC用マイク', 'クリエイティブ・メディア', 'ゲーミングモニター', 'スタンダードモニター',
        ...
        'ホーム・キッチン・食品': [
            'エコバッグ・買い物バッグ', 'お弁当箱・水筒', '置き型', 'キッチンクリーナー剤',
            'キッチン家電', 'キッチン用品', 'グラス・マグ', 'コーヒーメーカー',
            'コーヒー用品', '食器・ボトル・カトラリー', 'タオル', 'タンブラーグラス',
            'ちりとり', '使い捨てコーヒーフィルター', '調理小物', '電子レンジ調理用品',
            'トイレットペーパー', 'ドリンク', '鍋・フライパン', '鍋・フライパンミックスセット',
            '仏前ろうそく', '弁当箱', 'ペーパー・キッチン用品', 'ホーム＆キッチン',
            'ホーム・日用品', '保存容器・調味料入れ', '保存用バッグ・ポリ袋', 'リビング'
        ],
        '収納・オフィス': [
        ...
        // --- 美容 & ファッション ---
        '美容・健康': [
            'おしゃれカラコン', 'クレンジング', 'クレンジングオイル',
            '磁気・チタン・ゲルマニウムアクセサリー', 'スキンケア',
            'スキンケア・ボディケア', 'スキンケア・基礎化粧品', 'スペシャルケア',
            'スポーツケア用品', 'テカリ対策', '鍼・灸', 'ビューティー',
            'ファンデーション', 'フットマッサージャー', 'ヘアケア',
            'ヘアストレートナー', 'ヘアドライヤー', 'ベースメイク',
            'ベースメイク・フェイスメイク', 'ボディケア', '保湿ミスト・スプレー',
        ...
        '音楽・エンタメ': [
            'ギターアクセサリ', '初心者楽器', 'ビクターエンタテインメント', 'ミュージックCD・レコード', 'ユニバーサルミュージック', 'ワーナーミュージック・ジャパン'
        ],
