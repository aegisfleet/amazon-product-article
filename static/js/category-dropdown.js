...
(function () {
    ...
    const categoryGroups = {
        // --- IT & デバイス ---
        'PC・周辺機器': [
            '4K モニター', 'PC用マイク', 'ゲーミングモニター', 'スタンダードモニター',
            'スリーブ', 'セキュリティロック', 'ディスプレイ', 'トラックボール',
            'ドッキングステーション', 'パソコン', 'マウス', 'マウスパッド',
            'ミニ', 'メディアドライブ', 'リストレスト', '標準型ノートパソコン'
        ],
        'スマートフォン': [
        ...
        // --- 生活 & 家電 ---
        '家電': [
            '4K対応テレビ', 'HEPA空気清浄機', 'エアブローガン', 'スティッククリーナー',
            'ヒーター・加湿器', 'ホームプロジェクター', 'ワンルーム用加湿器', '一酸化炭素検知器',
            '加湿器', '大型家電', '季節・空調家電', '据付脚', '洗濯機',
            '洗濯機・乾燥機', '生活家電', '空気清浄機用アクセサリ', '空気清浄機用フィルタ',
            '静電式空気清浄機'
        ],
        'ホーム・キッチン・食品': [
            'お弁当箱・水筒', 'ちりとり', 'キッチン ストア', 'キッチンクリーナー剤',
            'キッチン家電', 'キッチン用品', 'グラス・マグ', 'コーヒーメーカー',
            'コーヒー用品', 'タオル', 'タンブラーグラス', 'トイレットペーパー',
            'ドリンク', 'ペーパー・キッチン用品', 'ホーム・日用品', 'ホーム＆キッチン',
            'リビング', '仏前ろうそく', '使い捨てコーヒーフィルター', '保存容器・調味料入れ',
            '保存用バッグ・ポリ袋', '弁当箱', '調理小物', '鍋・フライパン',
            '電子レンジ調理用品', '食器・ボトル・カトラリー'
        ],
        '収納・オフィス': [
        ...
        '美容・健康': [
            ...
            'マッサージ・ツボ押しグッズ', 'メイクアップ', 'ヨガ・ストレッチ・骨盤矯正',
        ...
        'ファッション': [
            'インソール', 'パジャマ・ルームウェアボトムス', 'ベスト', 'ベビーおむつ',
            'ベビー・マタニティ', 'ボーイズ', 'メンズシューズ'
        ],

        // --- ゲーム & エンタメ ---
        'ゲーム・おもちゃ': [
            'Nintendo Switch2/Switch', 'ゲーム機本体', 'ハンドル・ジョイスティック', '知育・学習玩具'
        ],
        '音楽・エンタメ': [
            'ビクターエンタテインメント', 'ユニバーサルミュージック', 'ワーナーミュージック・ジャパン'
        ],

        // --- レジャー & その他 ---
        'アウトドア・車': [
            'アウトドア ・キャンプ・旅行商材', 'スポーツ・アウトドア', '収納・ホルダー',
            '車・バイク', '車＆バイク'
        ],
        'その他': [
