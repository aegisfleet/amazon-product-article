...
(function () {
    ...
    const categoryGroups = {
        ...
        'PC・周辺機器': [
            ...
            'マウス', 'マウスパッド',
            'メディアドライブ', 'リストレスト', 'パソコン', 'ミニ', '標準型ノートパソコン', 'トラックボール'
        ],
        'スマートフォン': [
            'AC式充電器', 'iPhoneケース / フィルム', 'IPhoneケース / フィルム', 'ケース', 'スタンド', 'スマートウォッチ', 'スマートフォン関連製品',
            'スマホケース・カバー', 'スマホ本体', 'タブレット', 'Androidタブレット', '携帯電話ホルダー', '交換用ベルト'
        ],
        'オーディオ': [
        ...
        'ホーム・キッチン・食品': [
            ...
            'リビング', '保存用バッグ・ポリ袋', '弁当箱', '電子レンジ調理用品', '仏前ろうそく', 'ペーパー・キッチン用品'
        ],
        '収納・オフィス': [
            'オープンシェルフ・ラック', 'オフィスワークテーブル',
            'スチールラック本体', 'キッチンワゴン・収納カート', 'デスクチェア'
        ],
        ...
        '美容・健康': [
            ...
            'マッサージ・ツボ押しグッズ', 'ヨガ・ストレッチ・骨盤矯正', 'スキンケア・基礎化粧品'
        ],
        'サプリメント': [
            'サプリメント・ビタミン', 'ビタミン・サプリメント', 'ビタミンC', 'プロテイン', 'マルチビタミン', 'マルチミネラル', 'マルチ脂肪酸', 'ホエイプロテイン', '亜鉛'
        ],
        'ファッション': [
            'インソール', 'パジャマ・ルームウェアボトムス', 'ベビー・マタニティ', 'ベスト', 'メンズシューズ', 'ボーイズ', 'ベビーおむつ'
        ],
