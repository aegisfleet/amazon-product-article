...
(function () {
    ...
    const categoryGroups = {
        ...
        'ホーム・キッチン・食品': [
            '置き型', 'キッチンクリーナー剤',
            'キッチン家電', 'キッチン用品', 'タオル', 'タンブラーグラス',
            'ちりとり', '使い捨てコーヒーフィルター', '調理小物',
            'トイレットペーパー', 'ドリンク', '仏前ろうそく', '弁当箱', 'リビング'
        ],
        '収納・オフィス': [
            'オフィスワークテーブル', 'スチールラック本体', 'デスクチェア'
        ],
