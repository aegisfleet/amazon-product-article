...
(function () {
    ...
    const categoryGroups = {
        ...
        'ケーブル・ネットワーク': [
            'USBケーブル', 'ケーブルオーガナイザーバッグ', '電源タップ', '無線・有線LANルーター'
        ],

        // --- 生活 & 家電 ---
        '家電': [
            '4K対応テレビ', 'HEPA空気清浄機', '一酸化炭素検知器', 'エアブローガン', '家電・PC・周辺機器',
        ...
        'ホーム・キッチン・食品': [
            ...
            'トイレットペーパー', 'ドリンク', '鍋', '鍋・フライパンミックスセット', '仏前ろうそく', '弁当箱', '保存容器', '保存容器・キャニスター', '保存用バッグ・ポリ袋', 'リビング'
        ],
        '収納・オフィス': [
        ...
        // --- ゲーム & エンタメ ---
        'ゲーム・おもちゃ': [
            'ゲーム機本体', 'ゲームソフト', 'ハンドル・ジョイスティック'
        ],
        '音楽・エンタメ': [
            'アニメ・ゲーム', 'ギターアクセサリ', '初心者楽器', 'ビクターエンタテインメント', 'ミュージックCD・レコード', 'ユニバーサルミュージック', 'ワーナーミュージック・ジャパン'
        ],

        // --- レジャー & その他 ---
        'アウトドア・車': [
            'LEDランタン', 'アウトドア用エアーマット', '釣り', '燃料', 'ドライブ便利アイテム', '乗用車スノーチェーン', 'ライト・アクセサリ', 'ライト・ランタン'
        ],
        'その他': [
