      ...
      fc.asyncProperty(
          ...
          analysis: fc.record({
            ...
            userStories: fc.array(
              fc.record({
                ...
                sentiment: fc.constantFrom('positive', 'negative', 'mixed', 'neutral'),
              }),
              { minLength: 1, maxLength: 5 },
            ),
        ...
        async (investigationResult: InvestigationResult) => {
          ...
          const totalOriginalPoints =
            investigationResult.analysis.positivePoints.length + investigationResult.analysis.negativePoints.length;
          const totalProcessedInsights =
            analysisResult.positiveInsights.length + analysisResult.negativeInsights.length;
