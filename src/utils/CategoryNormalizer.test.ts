import { CategoryNormalizer, type BrowseNode } from './CategoryNormalizer';
...
describe('CategoryNormalizer', () => {
    ...
    describe('isValidCategoryName', () => {
        ...
        it('should return false for names matching invalid patterns', () => {
            const invalidNames = [
                'Sale', 'Off', 'Coupon', 'Ranking', 'Best', 'Week', 'Fair', 'Event', 'Campaign',
                'セール', 'クーポン', 'ランキング', 'おすすめ', 'ウィーク', 'フェア', 'イベント', 'キャンペーン',
                '新商品', 'すべて', '特設ページ', '発売日お届け', '父の日', '割引', 'お買い得',
                'non manga', 'KOS_123', 'Winter Favorites', '高評価ブランド', '今旬', 'サンプリング除外',
                'Node123', '特集', '新着', '新規発売', '予約', '限定', 'recommendation', 'eligible', 'widget',
                'smartphones', 'All Products', 'Prime Day', '【Category】', '(Category)', '_Category', '※Note',
                '家電', 'アクセサリ', 'アクセサリー', // Explicitly rejected exact matches
