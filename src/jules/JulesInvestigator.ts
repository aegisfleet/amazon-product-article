...
その場合は、商品の仕様、公式説明文、機能、シリーズの背景（前作がある場合など）、またはそのブランドの製品としての特徴に基づき、**「この商品そのものに特化した分析」**を深めてください。
具体的には：
1. 商品タイトルに含まれるキーワードや公式の機能リストから、この商品独自のメリット・デメリットを推測・分析する
2. 同価格帯の具体的な競合製品と比較した際、この商品のスペックがどのような立ち位置にあるか分析する
3. 前作やシリーズ製品がある場合、それらとの違いや進化点を含めてこの商品の価値を記述する
...
0. **商品概要と使い方**（サイト上部に表示する最重要情報）
   - **productName**: 正式な製品名（検索タグやSEOキーワードを除いた簡潔な名前）
     例：「Syncwire 3.5mm 4極オーディオ延長ケーブル 1.2m (2本セット)」
     ※ Amazonの商品タイトルには「【2本セット】【マイク対応】延長ケーブル ヘッドホン...」のような検索用タグが含まれることがありますが、ここでは「製品本来の名前」を記載してください
...
- 素晴らしい製品には95点以上、重大な欠陥がある製品には厳しく低い点数をつけてください。
