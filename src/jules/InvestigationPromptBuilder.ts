   ...
   **価格の正確な認識と二重価格（見せ金・異常割引率）の厳格な排除（最重要）**:
   ...
   - **二重価格（見せ金・異常割引率）の確実な見破り方（Amazon内データで完結する判定手順）**:
     ...
     3. **【ダミーバリエーション（見せ金）の比較】**:
      ...
      4. **【実在しない虚偽スペック・規格外表記の排除と最新規格の正確な判定】**:
        - **実在する正式規格の誤認防止（減点禁止）**: 以下の通信・給電規格等は正式に策定・実用化された実在規格であるため、単にバージョン表記のみを理由に「架空・虚偽」と断定して減点してはならない。
          - **Bluetooth**: Bluetooth 5.0 / 5.1 / 5.2 / 5.3 / 5.4 / 6.0 (2024年9月正式リリース)
          - **Wi-Fi**: Wi-Fi 5 (802.11ac), Wi-Fi 6 / 6E (802.11ax), Wi-Fi 7 (802.11be, 2024年策定)
          - **給電・ワイヤレス充電**: USB PD 3.0 / 3.1 (最大240W), Qi, Qi2 (MagSafe互換15W)
          - **USB / 映像**: USB 3.2, USB4, USB4 2.0, Thunderbolt 3 / 4 / 5, HDMI 2.0 / 2.1, DisplayPort 1.4 / 2.1
          - **セルラー**: 4G (LTE), 5G (Sub-6 / ミリ波)
        - **明確に架空・虚偽・スペック詐欺と判定する対象（大幅減点: -15〜-20点）**:
          - 未策定・未発表の架空規格（例: 「Bluetooth 7.0」「Bluetooth 8.0」「Bluetooth 5.8」「Wi-Fi 9」「Wi-Fi 10」「USB 6.0」「Thunderbolt 6」「6G / 7G」「HDMI 3.0」等）
          - 物理的・工学的に不可能な過大表記（例: 薄型・小型バッテリーで100,000mAh等）
          - これらを謳う商品は、スペック詐欺・虚偽表記として**信頼性・性能の観点から大幅減点（-15〜-20点）**する。絶対に「最新規格搭載」として加点してはならない。
      5. **【Amazon専売・ノーブランド品および物理的矛盾・誇大スペックの判定基準（極めて重要）】**:
        - **① 物理的矛盾・虚偽スペック商品（大幅減点: 55〜60点）**:
          「130g〜230gの軽量ファンに6,800mAh〜10,000mAhバッテリー」「-25℃〜-30℃瞬間冷却」「120〜199段階風量」「17,000rpm超高速」「400gで110KPa吸引」「Bluetooth 8.0」など、物理的・工学的に矛盾する、または架空の規格を謳う商品は、スペック詐欺・信頼性欠如として**性能・信頼性の観点から大幅減点（-10〜-15点）し、スコアを55〜60点程度**とする。
