...
- **客観性の維持**: 主観的な感想ではなく、スペックや検証されたユーザーレビューに基づいた客観的な事実のみを記載する。
...
- **クロスチェック**: 重要な品質・比較優位の主張は、2系統以上の独立ソースで一致確認する。
    ...
    "userStories": [
      {
        "userType": "属性",
        "scenario": "状況",
        "experience": "使い勝手、触り心地、利用シーンでの印象など、3行以上の具体的な実体験・使用感（データが存在しない場合はストーリー自体を削除する）",
