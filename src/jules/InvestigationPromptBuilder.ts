    ...
    "competitiveAnalysis": [
      {
        ...
        "priceComparison": "単なる価格の上下だけでなく、性能、成分、容量、耐久性などを踏まえた『割安か・割高か』の多角的な分析結果。例：『価格は競合より30%高いが、有効成分が2倍含まれており1回あたりのコストはむしろ低い』",
        "featureComparison": ["対象商品との『明確な共通点』", "対象商品との『決定的な相違点』"],
        "differentiators": ["『こういう場合は対象商品を買うべき』という具体的なケース", "『逆にこういう場合はこの競合商品の方が適している』という具体的なケース"]
      }
    ],
    "recommendation": {
