/**
 * sanitize-frontmatter.js
 * 
 * Sanitizes YAML frontmatter in Markdown files to fix common issues
 * that cause Hugo build failures, such as unescaped quotes in titles.
 */
 ...
 */
function escapeQuotesInYamlValue(value) {
